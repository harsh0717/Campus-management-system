...
$query = "
    SELECT u.name, s.roll_no, s.department, s.semester
    FROM users u
...
<style>
    ...
    .card-modern {
        ...
        height: auto;
        /* FIX: Prevents card from stretching to match sidebar height */
    }
    ...
    /* Added specific style for the badge icons */
    .text-theme-accent {
        color: var(--accent-color);
    }
...
<div class="container-fluid p-0">
    ...
    <div class="px-4 pt-4 pb-2">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="h3 fw-bold text-dark mb-2">Student Dashboard</h1>

                <!-- NEW DESIGN START -->
                <h5 class="text-secondary mb-3 fw-normal">
                    Welcome back, <span class="fw-bold text-dark"><?php echo htmlspecialchars($student['name']); ?> !</span>
                </h5>

                <div class="d-flex flex-wrap gap-2">
                    <!-- Department Badge -->
                    <div class="d-inline-flex align-items-center bg-white border px-3 py-1 rounded-pill shadow-sm text-muted">
                        <i class="fas fa-university me-2 text-theme-accent"></i>
                        <small class="fw-semibold"><?php echo htmlspecialchars($student['department']); ?></small>
                    </div>

                    <!-- Semester Badge -->
                    <div class="d-inline-flex align-items-center bg-white border px-3 py-1 rounded-pill shadow-sm text-muted">
                        <i class="fas fa-layer-group me-2 text-warning"></i>
                        <small class="fw-semibold">Semester <?php echo htmlspecialchars($student['semester']); ?></small>
                    </div>
                    <div class="d-inline-flex align-items-center bg-white border px-3 py-1 rounded-pill shadow-sm">
                        <i class="fas fa-id-card me-2 text-primary"></i>
                        <small class="text-muted fw-semibold me-1">Roll No:</small>
                        <small class="fw-bold text-dark"><?php echo htmlspecialchars($student['roll_no']); ?></small>
                    </div>
                </div>
                <!-- NEW DESIGN END -->
                ...
                <div class="stat-card">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="stat-trend text-trend-up"><i class="fas fa-check-circle me-1"></i> Good</div>
                        </div>
                ...
                <div class="stat-card green">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="stat-trend text-muted"><i class="fas fa-book-open me-1"></i> Active</div>
                        </div>
                ...
                <div class="stat-card orange">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="stat-trend text-danger fw-bold"><i class="fas fa-clock me-1"></i> 3 Days</div>
                        </div>
                ...
                <div class="stat-card purple">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="stat-trend text-trend-up"><i class="fas fa-arrow-up me-1"></i> Excellent</div>
                        </div>
